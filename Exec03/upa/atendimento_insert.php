<?php
	...
	if ( $resultado > 0 ) {
		...
		print 'Erro na inserção.';
	      ...
	      //TESTANDO SE A PALAVRA OCORRÊNCIA FOI DIGITADA
if(strpos( $_REQUEST['encaminhamento'],'ocorrência') !== false ){
	//ENCAMINHANDO A OCORRÊNCIA
	$obj = ['local' => 'UPA Bagé', 'descricao' => $_REQUEST['encaminhamento'] ];
	$txt = json_encode($obj);
    $curl = curl_init('localhost:8081/publica_servico.php');
